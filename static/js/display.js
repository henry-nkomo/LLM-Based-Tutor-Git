...
async function compWelcomeUser() {
    try {
        ...
        const compInitiateChat = await fetch('/comp-welcome-dialogue');
        ...
        console.log('could not initiate Comprehension dialogue ', error);
        hideTypingIndicator();
        return null
    }
}
...
async function compDialogue() {
    ...
    try {
        const response = await fetch('/comp-dialogue', {
            method: 'POST',
            headers: {
